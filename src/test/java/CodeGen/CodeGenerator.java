...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://mysql.m.aomygod.api:3306/admin_user_center";
    private static final String JDBC_USERNAME = "dev";
    private static final String JDBC_PASSWORD = "123456";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";
    public static final String BASE_PACKAGE = "cn.aylives.admin.user.center";//项目基础包名称，根据自己公司的项目修改
    public static final String TABLE_PREFIX = "t_";//表前缀
...
//        Gen.getInstance().genCode("litemall_brand","litemall_category");
        Gen.getInstance().genCode("t_dept");
//        Gen.getInstance().genCodeByCustomModelName("输入表名", "输入自定义Model名称");
    ...
    public static class Gen {
        ...
        private static final String AUTHOR = "CodeGen.CodeGenerator";//@author
        ...
        public static void genService(String tableName, String modelName) {
            try {
                ...
                File file = new File(PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE + modelNameUpperCamel + "Service" +
                                             ".java");
